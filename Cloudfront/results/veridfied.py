...
def domain_scanner(sub_domnames):
    ...
    for subdomain in sub_domnames:
        ...
        try:
            ...
            if sending_request.status_code == 400 and "Cache-Control" in sending_request.headers :
                if "miss" or "Miss" in sending_request.headers:
                    print("\n")
                    ...
                    space_line()                                                                                                                           
                    d = open("output-result.txt", "a")                                                                                                                               
                    d.name.splitlines()   
                    d.write(url + "\n"  + str(sending_request.headers) + "\n")                                                                                                                                                                                                                                                        
                    d.close()     

            elif sending_request.status_code == 400 :                                                                                                                             
                d = open("not-verified-result.txt", "a")                                                                                                                               
                d.name.splitlines()   
                d.write(url + "\n"  + str(sending_request.headers) + "\n")                                                                                                                                                                                                                                                        
                d.close()       
